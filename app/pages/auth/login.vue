      ...
      >
        ...
        <div class="space-y-8 text-center lg:text-left">
          ...
          <div class="space-y-4">
            ...
            >
              Transform Your
              <span class="block text-primary">Workforce Management</span>
            </h1>
            <p
              class="text-lg lg:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0"
            >
              Streamline operations, boost productivity, and manage your team
              with cutting-edge tools designed for modern businesses.
            </p>
          </div>
          ...
          <div class="flex flex-wrap gap-3 justify-center lg:justify-start">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                ></div>
                <span class="text-sm font-medium">AI-Powered Insights</span>
              </div>
            </div>
            <div
              class="px-4 py-2 bg-card border border-border/50 rounded-full shadow-sm backdrop-blur-sm"
